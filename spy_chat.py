...
STATUS_MESSAGES = ["Hey! My name is Prince", "I'm a spy", "Are you a spy too?"]
...
def add_status():
    ...
    default = raw_input("Do you want to use your older status? (y/n) ")

    if default.upper() == "N":
        new_status_message = raw_input("Insert your New Status:  ")
        ...
        print "This option is not valid. Please enter 'y' or 'n': "
